...
def fix_scan_file(data_dir, scan_number ):
    datfile = data_dir + "%s.dat" % scan_number
    nexusfile = data_dir +"%s.nxs" % scan_number
    correctedfile = data_dir + "%s_c.nxs" % scan_number
