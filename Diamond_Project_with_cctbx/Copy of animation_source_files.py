...
def draw_cuboid():
    ...
    f.plot_vectors_as_arrows(vectors[::2],fig,ax, color='red')
    f.plot_vectors_as_arrows(vectors[1::2], fig, ax, color='blue')
...
#             vectors = rm.rotate_list(chi_step, vectors)
#             fig = plt.figure()
#             ax = fig.add_subplot(121, projection='3d')
#             ax.set_xlim(-4,4)
#             ax.set_ylim(-4,4)
...
#             vectors = rm.rotate_list(phi_step, vectors)
#             fig = plt.figure()
#             ax = fig.add_subplot(121, projection='3d')
#             ax.set_xlim(-4,4)
#             ax.set_ylim(-4,4)
