#Source: https://zulko.wordpress.com/2012/09/29/animate-your-3d-plots-with-pythons-matplotlib/
...
def make_movie(files,output, fps=10 ,bitrate=100000,**kwargs):
    """
...
def make_gif(files,output,delay=30, repeat=False,**kwargs):
    """
...
def rotanimate(files, output, **kwargs):
    """
